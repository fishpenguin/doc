...
class Connection {
 public:
    ...
    virtual Status
    DescribeIndex(const std::string& table_name, std::vector<std::string>& field_name_array, IndexParam& index_param) const = 0;
    ...
    virtual Status
    DropIndex(const std::string & table_name, std::vector<std::string>& field_name_array) const = 0;
