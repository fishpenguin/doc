    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          set_error_code(static_cast<::demo::ErrorCode>(val));
        } else goto handle_unusual;
        continue;
      // string reason = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_reason(), ptr, ctx, "demo.Status.reason");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:demo.Status)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (8 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_error_code(static_cast< ::demo::ErrorCode >(value));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:demo.Status)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:demo.Status)
  return false;
#undef DO_
}
...
void Status::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:demo.Status)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:demo.Status)
}
